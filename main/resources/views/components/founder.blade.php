...
<section class=" p-2 bg-red-500 my-12 px-32">
    <div class="grid grid-cols-12 gap-4 p-2 bg-blue-600">
        <div class=" col-span-8 BG1 text-white p-5 px-6 rounded-3xl">
        ...
        <div class="grid grid-cols-12 gap-4 p-2 col-span-4 bg-pink-400">
            <div class=" bg-green-600 col-span-12 ">
                <div class=" bg-yellow-400 rounded-full flex justify-center items-center mb-4 relative">
                    <img class="rounded-full z-20" src="B_U/40.jpeg" alt="" style="width: 250px; height:250px;">
            ...
            <div class=" bg-white w-full p-6 rounded-xl border border-gray-700">
