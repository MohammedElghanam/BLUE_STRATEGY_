    ...
    <div class="grid max-w-screen-xl py-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 h-full mx-16">
        <div class="mr-auto place-self-center lg:col-span-7 mb-12 lg:mb-0">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 w-full mb-10">
                <div class="p-1 rounded-md hover:scale-105 transition-transform">
                    <div class="flex justify-center items-center p-2 rounded-full col-span-1">
            ...
            <a href="{{route('booking_now')}}"
               class="inline-flex items-center justify-center px-5 py-3 mr-3 mb-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Booking Now
            ...
            <a href="#contact"
               class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-blue-700 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                Contact
            </a>
        </div>
