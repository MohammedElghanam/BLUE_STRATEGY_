...
.polygon {
    ...
    background: linear-gradient(to right, #8b8200, #ffee00);
}
.COLOR{
            ...
            <div class="col-span-12 grid grid-cols-12 gap-2 mt-10">
                ...
                <div class="col-span-12 grid grid-cols-12 justify-center items-center gap-5 pl-2 md:pl-16 pt-6">
                    <div class="col-span-12 md:col-span-8">
                        <h1 class="font-semibold text-lg md:text-xl">BLUE STRATEGY élève vos projets digitaux à des niveaux supérieurs. </h1>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-6 bg-gray-100 p-6 lg:p-10 rounded-xl transition-transform transform hover:scale-105">
                ...
                <div class="grid grid-cols-1">
                    <div class="flex justify-start items-center gap-3 text-xl lg:text-2xl mb-4 font-semibold text-gray-900">
                        <svg class=" w-10 h-10" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="#8b8200" d="m10 17l-4-4l1.41-1.41L10 14.17l6.59-6.59L18 9m-6-8L3 5v6c0 5.55 3.84 10.74 9 12c5.16-1.26 9-6.45 9-12V5z"/></svg>                        <h1 class=" TIT">Nos specialités</h1>
                    </div>
...
<section class="pt-8 pl-8 my-7">
    <div class="F grid grid-cols-12 relative">
        <div class="w-full md:w-2/5 bg-white absolute -top-3 -left-3 px-2 pb-8">
                ...
                <div class="container max-w-full md:max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                    <div class="block max-w-full sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-50">
                        ...
                        <div class="p-6 space-y-2 lg:col-span-5">
                            <h3 class="text-lg md:text-2xl font-semibold sm:text-4xl">
                    ...
                    <div class="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="max-w-full mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                            <img role="presentation" class="object-cover w-full rounded h-32 sm:h-44 dark:bg-gray-500" src="B_U/FOR/7.svg">
                            <div class="p-6 space-y-2">
                                <h3 class="text-lg md:text-2xl font-semibold group-hover:underline group-focus:underline">
                                    DIGITAL LEARNING
                                </h3>
                                <div class="h-0.5 w-full bg-blue-900"></div>
                                <p>
...
{{-- <img class=" w-3/4" src="B_U/FOR/16.png" alt=""> --}}

{{-- <section class=" my-20">
    <div class=" grid grid-cols-12 bg-blue-700 p-2 pl-20">
        <div class=" col-span-6 bg-red-500">
            <div class=" w-full h-20 flex justify-start items-center bg-white">
                <div class=" w-40 h-1 bg-blue-900"></div>
            </div>
            <div class=" flex justify-start items-center gap-2">
                <h1 class=" text-5xl w-3/5">INGENIERIE DE FORMATION</h1>
            </div>
            <div class=" mt-7 grid gap-2 ml-16">
                <p class=" w-3/4 font-light text-xl">BLUE STRATEGY vous propose ses services pour la conception et la mise en œuvre de vos projets de formation.</p>
                <p class=" w-3/4 font-light text-xl">
        ...
        <div class=" col-span-6 bg-blue-900 relative">
            <div class=" w-10 h-10 bg-white absolute top-10 right-10"></div>
            <div class=" grid grid-cols-12 gap-2 p-2 -left-36 absolute w-3/4 bg-green-400">
                <div class="grid grid-cols-1 gap-2 p-2 col-span-4 h-full bg-yellow-400"> 
                    <div class=" col-span-1 h-40 bg-blue-600"> <img class=" h-full" src="B_U/FOR/10.svg" > </div>
                    <div class=" col-span-1 h-40 bg-blue-600"> <img class=" h-full" src="B_U/FOR/11.svg" > </div>
                    <div class=" col-span-1 h-20 bg-blue-600"></div>
                </div>
                <div class="grid grid-cols-1 gap-2 p-2 col-span-4 h-full bg-yellow-400"> 
                    <div class=" col-span-1 h-20 bg-blue-600"> </div>
                    <div class=" col-span-1 bg-blue-600"> <img src="B_U/FOR/12.svg" > </div>
                    <div class=" col-span-1 bg-blue-600"> <img src="B_U/FOR/13.svg" > </div>
                </div>
                <div class="grid grid-cols-1 gap-2 p-2 col-span-4 h-full"> 
                    <div class=" col-span-1 h-40"> <img class=" h-full" src="B_U/FOR/14.svg" > </div>
                    <div class=" col-span-1 h-40"> <img class=" h-full" src="B_U/FOR/15.svg" > </div>
                    
                    <div class=" col-span-1">
                        <div class=" absolute w-11/12 text-white">
                            <div class=" flex justify-start items-center gap-2">
                                <svg class=" w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32">
                                    <path fill="#8b8200" d="m31.707 19.293l-3-3a1 1 0 0 0-1.414 0L18 25.586V30h4.414l9.293-9.293a1 1 0 0 0 0-1.414M21.586 28H20v-1.586l5-5L26.586 23zM28 21.586L26.414 20L28 18.414L29.586 20zM16 22c-3.364 0-6-2.636-6-6s2.636-6 6-6s6 2.636 6 6s-2.636 6-6 6m0-10c-2.28 0-4 1.72-4 4s1.72 4 4 4s4-1.72 4-4s-1.72-4-4-4"/><path fill="#8b8200" d="m27.547 12l1.733-1l-2.336-4.044a2 2 0 0 0-2.373-.894l-2.434.823a11 11 0 0 0-1.312-.758l-.503-2.52A2 2 0 0 0 18.36 2h-4.72a2 2 0 0 0-1.962 1.608l-.503 2.519c-.46.224-.906.469-1.327.753l-2.42-.818a2 2 0 0 0-2.373.894l-2.36 4.088a2 2 0 0 0 .412 2.502l1.931 1.697C5.021 15.495 5 15.745 5 16q0 .387.028.766l-1.92 1.688a2 2 0 0 0-.413 2.502l2.36 4.088a2 2 0 0 0 2.374.894l2.434-.823q.627.423 1.312.758l.503 2.519A2 2 0 0 0 13.64 30H16v-2h-2.36l-.71-3.55a9.1 9.1 0 0 1-2.695-1.572l-3.447 1.166l-2.36-4.088l2.725-2.395a8.9 8.9 0 0 1-.007-3.128l-2.719-2.39l2.361-4.087l3.427 1.16A9 9 0 0 1 12.93 7.55L13.64 4h4.721l.71 3.55a9.1 9.1 0 0 1 2.695 1.572l3.447-1.166z"/>
                                </svg>
                                <h1 class=" font-semibold text-xl">Accompagnement de vos projets</h1>
                            </div>
                            <div class="">
                                <p>
                                ...
                                <div class=" bg-red-600 p-4 grid gap-3">
                                    <div class="  flex justify-start items-center gap-2">
                                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path fill="#3b4f72" d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/>
                                        </svg>
        ...
        <div class=" grid grid-cols-12 col-span-12 h-80">
            <div class=" col-span-6"></div>
            <div class=" col-span-6 bg-blue-900"></div>
        </div>
    </div>
</section> --}}
{{-- 
<section class="my-20">
    <div class="grid grid-cols-12 bg-blue-700 p-2 lg:pl-20">

        <div class="grid grid-cols-12 col-span-12 h-20 justify-start items-center bg-white mb-2">
           <div class=" col-span-6 h-full flex justify-start items-center bg-yellow-300">
                <div class="w-40 h-1 bg-blue-900"></div>
           </div>
        ...
        <div class="grid grid-cols-12 p-2 gap-2 col-span-12 lg:col-span-12 bg-red-500">
        ...
        <div class="grid grid-cols-12 p-2 gap-2 col-span-12 lg:col-span-12 bg-red-500">
            ...
            <div class="col-span-6 bg-green-500">
                <img src="B_U/FOR/11.svg">
            </div>

            <div class="col-span-6 bg-blue-900">
        ...
        <div class="col-span-12 lg:col-span-6 bg-blue-900 relative p-4">
            <div class="grid grid-cols-1 gap-2 p-2 absolute w-full lg:w-3/4 bg-green-400 h-full -left-36 lg:-left-36">
                <div class="grid grid-cols-12 gap-2 p-2 col-span-1 h-full bg-yellow-400">
                    <div class="col-span-4 bg-blue-600"> <img src="B_U/FOR/10.svg"> </div>
                    <div class="col-span-4 bg-blue-600"></div>
                    <div class="col-span-4 bg-blue-600"> <img src="B_U/FOR/14.svg">  </div>
                </div>
                <div class="grid grid-cols-12 gap-2 p-2 col-span-1 h-full bg-yellow-400">
                    <div class="col-span-4 bg-blue-600">  <img src="B_U/FOR/11.svg"> </div>
                    <div class="col-span-4 bg-blue-600"> <img src="B_U/FOR/12.svg"> </div>
                    <div class="col-span-4 bg-blue-600"> <img src="B_U/FOR/13.svg"> </div>
                </div>
                <div class="grid grid-cols-12 gap-2 p-2 col-span-1 h-full bg-yellow-400">
                    <div class="col-span-4 bg-blue-600"> </div>
                    <div class="col-span-4 bg-blue-600"> <img src="B_U/FOR/15.svg"> </div>
                    <div class="col-span-4 bg-blue-600"> </div>
        ...
        <div class="grid grid-cols-12 col-span-12 h-80">
            ...
            <div class="col-span-6 bg-blue-900">
                <div class=" w-11/12 relative">
                    <div class=" absolute right-0 mt-10 text-white">
                        <div class=" flex justify-start items-center gap-2">
                            <svg class=" w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32">
                                <path fill="#8b8200" d="m31.707 19.293l-3-3a1 1 0 0 0-1.414 0L18 25.586V30h4.414l9.293-9.293a1 1 0 0 0 0-1.414M21.586 28H20v-1.586l5-5L26.586 23zM28 21.586L26.414 20L28 18.414L29.586 20zM16 22c-3.364 0-6-2.636-6-6s2.636-6 6-6s6 2.636 6 6s-2.636 6-6 6m0-10c-2.28 0-4 1.72-4 4s1.72 4 4 4s4-1.72 4-4s-1.72-4-4-4"/><path fill="#8b8200" d="m27.547 12l1.733-1l-2.336-4.044a2 2 0 0 0-2.373-.894l-2.434.823a11 11 0 0 0-1.312-.758l-.503-2.52A2 2 0 0 0 18.36 2h-4.72a2 2 0 0 0-1.962 1.608l-.503 2.519c-.46.224-.906.469-1.327.753l-2.42-.818a2 2 0 0 0-2.373.894l-2.36 4.088a2 2 0 0 0 .412 2.502l1.931 1.697C5.021 15.495 5 15.745 5 16q0 .387.028.766l-1.92 1.688a2 2 0 0 0-.413 2.502l2.36 4.088a2 2 0 0 0 2.374.894l2.434-.823q.627.423 1.312.758l.503 2.519A2 2 0 0 0 13.64 30H16v-2h-2.36l-.71-3.55a9.1 9.1 0 0 1-2.695-1.572l-3.447 1.166l-2.36-4.088l2.725-2.395a8.9 8.9 0 0 1-.007-3.128l-2.719-2.39l2.361-4.087l3.427 1.16A9 9 0 0 1 12.93 7.55L13.64 4h4.721l.71 3.55a9.1 9.1 0 0 1 2.695 1.572l3.447-1.166z"/>
                            </svg>
