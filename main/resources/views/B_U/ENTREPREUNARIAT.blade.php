...
{{-- <section class=" px-20">
    <div class=" grid grid-cols-12 gap-2 p-2">
        <div class=" col-span-5 p-10 pt-28">
            <div class=" flex">
                <div class=" ">
                    <img class=" w-10 h-10" src="B_U/35.png" alt="">
                </div>
                <h1 class="TIT mb-4 text-2xl font-semibold"> ACCOMPAGNEMENT DES ORGANISMES ENGAGÉS </h1>
            </div>
            <p class=" mb-4">
        ...
        <div class=" grid grid-cols-12 gap-4 col-span-7">
            <div class=" grid grid-cols-1 gap-2 col-span-5">
                <div class="">
            ...
            <div class=" BG col-span-7 rounded-xl p-5">
                ...
                <div class=" grid grid-cols-12 gap-3 text-white text-center p-2 lg:text-left mr-2">
                    ...
                    <div class=" col-span-12 flex justify-start items-center gap-4">
                        ...
                        <p class=" textwhite0 font-medium XS">Concevoir et réaliser des plans d'accompagnement adaptés.</p>
                    </div>
                    <div class=" col-span-12 flex justify-start items-center gap-4">
                        <div class="">
                            <svg class=" w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="9"/><path stroke-dasharray="14" stroke-dashoffset="14" d="M8 12L11 15L16 10"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.3s" values="14;0"/></path></g></svg>
                        </div>
                        <p class=" text-white font-medium XS">Définir les stratégies et modéliser les activités liées à la mise à l'échelle.
                        </p>
                    </div>
                    <div class=" col-span-12 flex justify-start items-center gap-4">
                        <div class="">
                        ...
                        <p class=" text-white font-medium XS">Évaluer l'impact social cible.
                        </p>
                    </div>
                    <div class=" col-span-12 flex justify-start items-center gap-4">
                        <div class="">
                    ...
                    <div class=" col-span-12 flex justify-start items-center gap-4">
                        ...
                        <p class=" text-white font-medium XS">Former les unités de coordination sur divers sujets.
                        </p>
                    </div>
                    <div class=" col-span-12 flex justify-start items-center gap-4">
                        <div class="">
                    ...
                    <div class=" col-span-12 flex justify-start items-center gap-4">
                        ...
                        <p class=" text-white font-medium XS">Mettre en place des plans de formation.
                        </p>
                    </div>
                    <div class=" col-span-12 flex justify-start items-center gap-4">
                        <div class="">
                        ...
                        <p class=" text-white font-medium XS">Déléguer l'équipe d'experts et de professionnels.
                        </p>
                    </div>
                    <div class=" col-span-12 flex justify-start items-center gap-4">
                        <div class="">
...
{{-- <section class=" p-20 relative">
    <div class=" BG w-48 h-48 absolute top-0 left-0 z-40"></div>
    <div class=" SHADOW p-20 h-96 grid justify-center items-center relative">
        <div class=" pt-10">
            <h1 class="FONT text-center mb-16"> ENTREPREUNARIAT </h1>
            ...
            <p class=" mb-4 text-center text-gray-800">
                ...
                enrichir la culture entrepreneuriale, dans le but d'encourag
            </p>
        </div>
        <div class=" BG w-16 h-48 absolute bottom-20 right-0 z-40"></div>
    </div>
</section> --}}


{{-- <section class="p-6 md:p-20 relative">
    <div class="BG w-24 h-24 md:w-48 md:h-48 absolute top-0 left-0 z-40"></div>
    <div class="SHADOW p-6 md:p-20 h-auto grid justify-center items-center relative">
        <div class="pt-6 md:pt-10">
            <h1 class="FONT text-center mb-8 md:mb-16">ENTREPREUNARIAT</h1>
            <p class="mb-2 md:mb-4 text-center font-medium">
                Notre mission est de rendre simple et naturel l’entrepreneuriat pour libérer les
                potentiels, transformant ainsi l'acte d'entreprendre en une aventure épanouissante.
            </p>
            <p class="mb-2 md:mb-4 text-center text-gray-800">
                L'écosystème entrepreneurial au Maroc connaît une évolution continue et joue un rôle
                essentiel dans le développement économique et social du pays, tout comme dans
                d'autres nations. Dans cette optique, une variété d'initiatives sont déployées pour
        ...
        <div class="BG w-8 h-24 md:w-16 md:h-48 absolute bottom-10 md:bottom-20 right-0 z-40"></div>
    </div>
</section> --}}
