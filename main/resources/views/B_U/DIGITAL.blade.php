        ...
        <div class="col-span-12 md:col-span-6 grid grid-cols-12 gap-4">
            <div class="col-span-12 grid grid-cols-12 gap-2 mt-10">
                <div class="col-span-12 flex justify-start items-center gap-2">
                    ...
                    <h1 class="TIT font-bold text-xs lg:text-xl">BLUE STRATEGY- SERVICES DEGITAUX</h1>
                </div>
                <div class="col-span-12 grid grid-cols-12 justify-center items-center gap-5 p-3 pl-6 lg:pl-16 pt-6 ">
                    <div class="col-span-12 lg:col-span-12">
                        <h1 class="font-medium text-base lg:text-lg">Nous élèvons vos projets digitaux à des niveaux supérieurs. </h1>
                    </div>
                    <div class=" grid grid-cols-12 col-span-12 lg:col-span-12">
                        <p class="col-span-12 text-base lg:text-lg font-light mb-3">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 justify-center items-center p-2 mt-20">
        <div class="grid grid-cols-1 lg:grid-cols-12 col-span-12 gap-4 p-4 lg:p-10 border-2 border-gray-300 rounded-3xl relative">
            <div class=" col-span-12 flex justify-center items-center">
                <div class="absolute -top-4 lg:-top-7 bg-white px-6 lg:px-8 text-center text-xl lg:text-4xl font-bold text-gray-900">
            ...
            <div class="col-span-12 lg:col-span-6 bg-gray-100 p-3 lg:p-10 rounded-xl transition-transform transform hover:scale-105">
                ...
                <div class="grid grid-cols-1">
                    <div
                        ...
                        <svg class=" w-8 h-8 lg:w-10 lg:h-10" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="#ae00ff" d="m10 17l-4-4l1.41-1.41L10 14.17l6.59-6.59L18 9m-6-8L3 5v6c0 5.55 3.84 10.74 9 12c5.16-1.26 9-6.45 9-12V5z"/></svg>
...
<section id="digital" class="mt-4">
    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 px-4 md:px-20">
        ...
        <div class="col-span-1 md:col-span-6 grid grid-cols-1 gap-4">
            <div class="p-2">
                <div class=" pb-6 p-0 lg:p-6">
                    <p class="font-normal lg:font-medium text-gray-900">
        ...
        <div class="grid grid-cols-12 gap-2 col-span-12">
            <div class="grid grid-cols-12 gap-6 p-2 col-span-12 lg:col-span-9">
                <div class="grid grid-cols-12 gap-2 col-span-12 pb-4 mt-6 BOR_1">
                    ...
                    <div class="col-span-12 lg:col-span-6 lg:flex justify-start items-center gap-4 hidden">
                        <div>
                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="col-span-12 lg:col-span-6 flex justify-start items-center gap-4 BOR_1 pb-4 lg:hidden mb-2">
                        <div>
                            <img class=" w-8 h-8" src="B_U/FOR/22.png" alt="">
                        </div>
                        <p class="TIT text-2xl font-bold">UX/UI DESIGN</p>
    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="grid grid-cols-12 gap-2 col-span-12 lg:col-span-6 p-4 lg:p-10 lg:pl-20">
            <div class="grid items-center col-span-12">
                <div class="TIT flex justify-start items-center gap-2 text-white text-lg lg:text-2xl font-bold">
        ...
        <div class="BOT grid grid-cols-12 gap-2 p-4 lg:p-10 col-span-12 mb-4 lg:mb-0">
            <div class="col-span-12 md:col-span-6">
                <div>
                    <h1 class="text-white">Toutes nos solutions sont :</h1>
                    <div class="mt-4 grid gap-4 pl-0 lg:pl-4">
                        <div class="flex justify-start items-center gap-2 text-white">
                            ...
                            <h1 class=" text-sm lg:text-base">EVOLUTIVES ET FONCTIONNELLEMENT RICHES</h1>
                        </div>
                        <div class="flex justify-start items-center gap-2 text-white">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                                <g fill="none" stroke="white" stroke-linejoin="round" stroke-width="4">
                            ...
                            <h1 class=" text-sm lg:text-base">SIMPLES D’UTILISATION</h1>
                        </div>
                        <div class="flex justify-start items-center gap-2 text-white">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                                <g fill="none" stroke="white" stroke-linejoin="round" stroke-width="4">
                            ...
                            <h1 class=" text-sm lg:text-base">PERSONNALISABLES</h1>
                        </div>
                        <div class="flex justify-start items-center gap-2 text-white">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                                <g fill="none" stroke="white" stroke-linejoin="round" stroke-width="4">
                            ...
                            <h1 class=" text-sm lg:text-base">DISPONIBLES EN MODE SAAS OU ON-PREMISE</h1>
                        </div>
                        <div class="flex justify-start items-center gap-2 text-white">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                                <g fill="none" stroke="white" stroke-linejoin="round" stroke-width="4">
                            ...
                            <h1 class=" text-sm lg:text-base">SÉCURITÉ ET CONFIDENTIALITÉ</h1>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="Intégration" class="px-4 lg:px-32">
    <div class="grid grid-cols-12">
        <div class="grid grid-cols-12 col-span-12 lg:col-span-6 pl-4 lg:pl-0">
            ...
            <div class="grid justify-center lg:justify-end items-center col-span-12 md:col-span-6">
                <img class=" w-3/4 lg:w-11/12 ml-10 lg:ml-0" src="BU_3/integration/3.png" alt="">
            </div>
        </div>
        <div class="col-span-12 lg:col-span-6">
        ...
        <div class="BOT grid grid-cols-12 gap-2 p-4 lg:p-10 col-span-12 relative">
            <div class=" BOT w-16 h-16 lg:w-20 lg:h-20 rounded-full flex justify-center items-center absolute -top-8 lg:-top-10 lg:left-10 right-10">
                <svg class=" w-8 h-8 lg:w-10 lg:h-10" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48">
                    <g fill="none" stroke="white" stroke-linejoin="round" stroke-width="4">
                        <path d="M24 44c11.046 0 20-8.954 20-20S35.046 4 24 4S4 12.954 4 24s8.954 20 20 20Z"/>
                        <path stroke-linecap="round" d="M24 16v16m-8-8h16"/>
                    </g>
            ...
            <div class="col-span-12 md:col-span-4 grid items-center">
                <div class=" flex justify-start items-end gap-4 mt-5 lg:mt-0">
                    <img class=" w-8 h-8 lg:w-12 lg:h-12" src="B_U/FOR/17.png" alt="">
                    <div class="">
                        <h1 class="font-bold text-white w-full lg:w-1/2">DEVELOPPEMENT SPECIFIQUE</h1>
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 justify-center items-center p-2 mt-20">
        <div class="grid grid-cols-1 lg:grid-cols-12 col-span-12 gap-4 p-3 lg:p-10 border-2 border-gray-300 rounded-3xl relative">
            <div class=" col-span-12 flex justify-center items-center mb-5">
                <div class="absolute -top-8 lg:-top-14 w-3/4 lg:w-1/3 bg-white p-2 text-center text-xl lg:text-4xl font-medium lg:font-semibold text-gray-900">
                    <h1 class=" TIT mb-2">Services AMOA IT</h1>
                    <p class=" text-xs lg:text-lg text-gray-700">  ASSISTANCE A LA MAITRISE D'OUVRAGE </p>
                </div>
            </div>

            <div class="col-span-12 lg:col-span-6 bg-gray-100 p-3 lg:py-10 rounded-xl transition-transform transform hover:scale-105">
                
                <div class="grid grid-cols-1">
                    <div class="flex justify-start items-center gap-1 text-sm lg:text-lg mb-4 font-medium text-gray-900">
                        <h1 class="">
                    ...
                    <div class="flex justify-start items-center gap-3 mb-4 text-gray-900">
                        <h1 class=" text-gray-800 text-sm lg:text-lg">
            ...
            <div class="col-span-12 lg:col-span-6 p-3 bg-gray-100 lg:p-10 rounded-xl transition-transform transform hover:scale-105 ml-2">
                ...
                <div class="grid grid-cols-12 mb-3">
                    <div class=" col-span-12">
                        <div class=" flex justify-start items-center  gap-4">
                            <div class=" w-9 h-9 lg:w-14 lg:h-14 flex justify-center items-center font-bold text-lg lg:text-3xl bg-blue-700 text-white">01</div>
                            <p class=" text-gray-900 font-medium">Assistance au pilotage de projet</p>
                        </div>
                        <div class=" flex justify-start items-center  gap-4">
                            <div class=" w-32 h-14 hidden lg:block"></div>
                            <p class=" ml-0 lg:ml-5 mt-3 lg:mt-0 text-gray-800 text-sm lg:text-base">
                ...
                <div class="grid grid-cols-12 mb-3">
                    <div class=" col-span-12">
                        <div class=" flex justify-start items-center  gap-4">
                            <div class=" w-9 h-9 lg:w-14 lg:h-14 flex justify-center items-center font-bold text-lg lg:text-3xl bg-blue-700 text-white">02</div>
                ...
                <div class="grid grid-cols-12 mb-3">
                    <div class=" col-span-12">
                        <div class=" flex justify-start items-center  gap-4">
                            <div class=" w-9 h-9 lg:w-14 lg:h-14 flex justify-center items-center font-bold text-lg lg:text-3xl bg-blue-700 text-white">03</div>
